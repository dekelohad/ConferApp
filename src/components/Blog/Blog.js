...
const Blog = () => (
  <section css={styles} className="blog" id="blog">
    ...
    <Container>
      <BlogCard blogImg={BlogOneBg} blogTitle="React Conference" />
      <BlogCard blogImg={BlogTwoBg} blogTitle="UI UX Conference" />
      <BlogCard blogImg={BlogThreeBg} blogTitle="Backend Conference" />
    </Container>
  </section>
);
