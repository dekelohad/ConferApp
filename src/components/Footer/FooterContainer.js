  ...
  return (
    <div css={styles} className="footerContainer">
      <div className="footerCard first">
        ...
        <p>
          confer is the biggest and the most advanced conference related to
          React.
        </p>
      ...
      <div className="footerCard second">
        <h2>Contact</h2>
        <p>
          <i className="far fa-map fa-sm"></i> 1966 John Calvin , Chicago
        </p>
        <p>
          <i className="fas fa-phone fa-sm"></i> (708)-931-8926
        </p>
        <p>
          <i className="fas fa-envelope fa-sm"></i> conferapp@gmail.com
        </p>
        <p>
          <i className="fas fa-globe-europe fa-sm"></i>
          conferapp.netlify.app
        </p>
      </div>
      <div className="footerCard third">
        <h2>Conferences</h2>
        <a href="#/">New York Conference</a>
        <a href="#/">London Conference</a>
        <a href="#/">Moscow Conference</a>
        <a href="#/">Paris Conference</a>
      </div>
